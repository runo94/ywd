...
function bones_theme_support()
{
	...
	// default thumb size
	set_post_thumbnail_size(380, 430, true);
	...
	add_theme_support(
		...
		array(
			...
			'default-color' => '',
			// background color default (dont add the #)
...
add_action('wp_ajax_get_ajax_predictions_posts', 'get_ajax_predictions_posts');
add_action('wp_ajax_nopriv_get_ajax_predictions_posts', 'get_ajax_predictions_posts');

function get_ajax_predictions_posts()
{
	// Query Arguments
	$args = array(
...
add_action('wp_ajax_get_ajax_afirmations_posts', 'get_ajax_afirmations_posts');
add_action('wp_ajax_nopriv_get_ajax_afirmations_posts', 'get_ajax_afirmations_posts');

function get_ajax_afirmations_posts()
{
	// Query Arguments
	$args = array(
		'post_type' => array('custom_type'),
